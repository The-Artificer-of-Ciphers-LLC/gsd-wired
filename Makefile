...
##   1. Export your "Developer ID Application" cert as ~/.private_keys/dev-certificate.p12
...
##        MACOS_SIGN_P12        — base64-encoded .p12:  base64 -i ~/.private_keys/dev-certificate.p12
